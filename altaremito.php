...
<head>
    ...
    if(isset($_POST['enviar']))
    {
        ...
        $consulta = "INSERT INTO remitos (num_remito, cuit, num_pedido, fecha_remito) VALUES ('$num_remito', '$cuit', '$num_pedido', '$fecha_remito')";
            ...
            <form action="altaremito.php" method="POST" name="agenda-alta" style="background-color: white" class="p-3">
                ...
                <div class="form-group row">
                    <div class="col-sm-3">
                        ...
                        <input type="text" class="form-control" id="num_remito" name="num_remito" placeholder="Numero de Remito" title="Ingresa 10 digitos para el Numero de Remito" maxlength="10" required="true">
                    </div>

                    <div class="col-sm-2">
                        <label for="cuit">Nº CUIT</label>
                        <input value="<?php echo $cuit?>" type="text" class="form-control" id="cuit" name="cuit" placeholder="Numero de CUIT" maxlength="11" required="true" readOnly>
                    </div>

                    <div class="col-sm-2">
                        <label for="razonsocial">Razon Social</label>
                        <input value="<?php echo $razonsocial?>" type="text" class="form-control" id="razonsocial" name="razonsocial" placeholder="Apellido" maxlength="30" readOnly>
                    </div>

                    <div class="col-sm-2">
                        <label for="num_pedido">Nº Pedido</label>
                        <input value="<?php echo $num_pedido?>" type="text" class="form-control" id="num_pedido" name="num_pedido" placeholder="Numero del Pedido" maxlength="10" required="true" readOnly>
                    </div>

                    <div class="col-sm-2">
                        <label for="fecha_remito">Fecha de Remito</label>
                        <input type="text" class="form-control" id="fecha_remito" name="fecha_remito" placeholder="Fecha" maxlength="10" required="true">
                    </div>
                </div>
