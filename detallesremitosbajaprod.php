...
<head>
    ...
    if(isset($_POST['enviar']))
    {
        ...
        $consulta = "DELETE FROM detalles_remitos WHERE num_remito = '$num_remito' AND cod_producto = '$cod_producto'  ";
        ...
        $consulta = "SELECT * FROM detalles_remitos WHERE num_remito = '$num_remito' AND cod_producto = '$cod_producto'";
            ...
            <div class="col">
                ...
                <div class="form-group row">
                    <div class="col">
                        ...
                        <input value="<?php echo $num_remito?>" type="text" class="form-control" id="txtNro_Remito" name="num_remito" placeholder="Numero de Remito" readOnly>
                    </div>
    
                    <div class="col">
                        <label for="cod_producto">Codigo Producto</label>
                        <input value="<?php echo $cod_producto?>" type="text" class="form-control" id="txtCod_Producto" name="cod_producto" placeholder="Codigo de Producto" readOnly>
                    </div>

                    <div class="col-sm-3">
                        <label for="descripcion">Producto</label>
                        <input value="<?php echo $descripcion?>" type="text" class="form-control" id="txtDesc_Prod" name="descripcion" placeholder="Producto" readOnly>
                    </div>
                      
                    <div class="col-sm-2">
                        <label for="txtCantidad">Cantidad</label>
                        <input value="<?php echo $Cantidad?>" type="number" class="form-control" id="txtCantidad" name="cantidad" placeholder="Cantidad" readOnly>
                    </div>
