...
<head>
    ...
    if(isset($_POST['enviar']))
    {
        ...
        $consulta = "DELETE FROM detalles_pedidos WHERE num_pedido = '$num_pedido' AND cod_producto = '$cod_producto'  ";
            ...
            <div class="col">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-1">
                        ...
                        <input value="<?php echo $cantidad?>" type="number" class="form-control" id="cantidad" name="cantidad" placeholder="Cantidad" required="true" readOnly>
                    </div>
    
                    <div class="col">
                        <label for="estado_prod">Estado de Productos</label>
                        <input value="<?php echo $estado_prod?>" type="text" class="form-control" id="estado_prod" name="estado_prod" placeholder="Estado de Productos" required="true" readOnly>
                    </div>
    
                    <div class="col">
                        <label for="observacion">Observacion</label>
                        <input value="<?php echo $observacion?>" type="text" class="form-control" id="observacion" name="observacion" placeholder="Descripcion" readOnly>
                    </div>
                </div>
