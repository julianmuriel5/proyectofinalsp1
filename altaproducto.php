...
<head>
    ...
    <title>Añadir Nuevo Prodocuto</title>
     <?php
        // Conexión
    ...
    if(isset($_POST['enviar']))
    {
        ...
        $consulta = "INSERT INTO productos (cod_producto, descripcion) VALUES ('$cod_producto', '$descripcion')";
     ...
     <form action="altaproducto.php" method="POST" name="agenda-alta" style="background-color: white" class="p-3">
                ...
                <div class="form-group row">
                    ...
                    <div class="col">
                        ...
                        <input type="text" class="form-control" id="cod_producto" name="cod_producto" placeholder="Codigo del Producto" title="Ingrese 12 digitos del codigo de producto" maxlength="12" required="true">
                    </div>

                    <div class="col">
                        <label for="descripcion">Producto</label>
                        <input type="text" class="form-control" id="descripcion" name="descripcion" placeholder="Producto" maxlength="30" required="true">
                    </div>
