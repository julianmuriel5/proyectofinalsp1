...
<body>
   ...
   <header>
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                <h1>Baja Productos</h1>
                 <form action="bajaProductos.php" method="POST" name="agenda-baja" style="background-color: white" class="p-3">
    
                <div class="form-group row">

                    <div class="col-sm-4">
                        <label for="cod_producto">Codigo Producto</label>
                        <input value="<?php echo $cod_producto?>" type="text" class="form-control" id="cod_producto" name="cod_producto" placeholder="Codigo Producto" readonly>
                    </div>
